...
// Compute taxes for all filing statuses as of the year 2009.
	public static void main(String[] args)
	{
		...
		// compute married jointly or qualifying widower filing status
		else if (status == 1)
		{
			if (income <= 16700)
			{
		...
		// compute married filing separately filing status
		else if (status == 2)
		{
			if (income <= 8350)
			{
		...
		// compute head of household filing status
		else if (status == 3)
		{
			if (income <= 11950)
			{
			...
			{
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (income - 45500) * 0.25 + (income - 117450) * 0.28;
			}
			else if (income <= 372950)
			{
