package com.andrew.codingpractice.section_3_5;

import java.util.Scanner;

public class Main
{
	// Program prompts user to to enter an integer for today's day of the week.
	// Program then prompts user to enter the number of days after today for
	// a future day and display the future day of the week
